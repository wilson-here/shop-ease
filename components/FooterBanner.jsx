...
const FooterBanner = ({
  ...
  return (
    <div
      className="banner-desc bg-[#f02d34] p-6 rounded-2xl relative text-white mt-12 flex flex-col gap-2 w-full md:min-h-[250px] md:flex-row md:justify-between md:items-center
    md:p-10 md:bg-transparent xl:min-h-[350px] xl:mt-20 before:content-[''] before:inset-0 before:w-full before:h-full before:bg-[#f02d34] before:absolute before:-z-20 before:rounded-2xl "
    >
      ...
      <img
        ...
        className="-top-25 left-22 object-contain
          m-auto w-full max-w-[300px] md:max-w-[400px] md:absolute md:m-auto md:inset-0 md:-z-10 xl:-top-10 xl:max-w-[500px]"
      />
      <div className="right self-start md:self-center">
        <p className="text-sm lg:text-lg">{smallText}</p>
        <h3 className="font-extrabold text-3xl">{midText}</h3>
